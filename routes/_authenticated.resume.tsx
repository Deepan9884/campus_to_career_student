              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    title="Delete resume"
                    className="opacity-0 group-hover:opacity-100 p-1 text-muted-foreground hover:text-red-400 hover:bg-red-500/10 rounded transition"
                  >
          ...
          {pagination && pagination.totalPages > 1 && (
            <div className="flex justify-center items-center gap-2 mt-4 pt-2 border-t border-white/5">
              <button
                ...
                className="text-xs px-2.5 py-1 rounded-lg glass hover:bg-white/10 disabled:opacity-30 transition"
              >
                Prev
              </button>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Get an ATS score and actionable AI feedback in seconds.
          </p>
        </div>
        {hasActiveAnalysis && (
          <button
            onClick={resetUpload}
            className="self-start md:self-auto glass rounded-xl px-4 py-2 text-xs font-medium hover:bg-white/10 flex items-center gap-2 transition"
          >
            ...
            <GlassCard data-tour="resume-upload-zone" className="relative overflow-visible">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 text-xs flex items-center gap-1.5 font-medium">
                    <Zap className="h-3 w-3 text-emerald-400" /> 1-Click AI Rewrites
                  </span>
                </div>
              </div>
              ...
              {mode === "failed" && (
                <div className="mt-4 p-3 rounded-xl bg-red-500/10 border border-red-500/30">
                  ...
                  <button
                    onClick={resetUpload}
                    className="mt-2 text-xs px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 transition"
                  >
                    Try again
                  </button>
                </div>
          ...
          >
            <div className="grid lg:grid-cols-[1fr_2fr] gap-6 items-start">
              ...
              <GlassCard data-tour="resume-upload-zone" className="space-y-5">
                <div className="flex items-center justify-between">
                  <h3 className="font-semibold text-sm">Upload Resume</h3>
                  <button
                    onClick={resetUpload}
                ...
                {mode === "uploading" ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      <p className="text-xs mt-2 font-medium">Upload another resume</p>
              ...
              >
                <GlassCard variant="strong" className="relative overflow-hidden">
                  ...
                  <div className="flex items-center justify-between pb-4 mb-5 border-b border-white/10">
                    ...
                    <button
                      onClick={resetUpload}
                      className="p-1.5 rounded-lg text-muted-foreground hover:text-white hover:bg-white/10 transition shrink-0"
                      ...
                      <div>
                        ...
                        {display._id && (
                          <button
                            ...
                            className="mt-4 text-xs px-4 py-2 rounded-xl glass hover:bg-white/10 transition"
                          >
                            View details
                          </button>
                        )}
              ...
              <GlassCard variant="strong" className="relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-3">
                    <button
                      onClick={resetUpload}
                      className="w-full group p-4 rounded-2xl bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-500/25 hover:border-indigo-500/50 hover:from-indigo-500/15 hover:to-purple-500/15 transition-all duration-300 flex items-center gap-3"
                    >
          ...
          <GlassCard variant="strong" className="max-w-md w-full">
            ...
            <div className="flex gap-3 mt-4">
              <button
                ...
                className="glass rounded-xl px-4 py-2 text-sm flex-1 hover:bg-white/10 transition"
              >
                Cancel
              </button>
              <button
                ...
                className="rounded-xl px-4 py-2 text-sm flex-1 bg-red-500/30 text-red-100 hover:bg-red-500/50 transition disabled:opacity-50"
              >
