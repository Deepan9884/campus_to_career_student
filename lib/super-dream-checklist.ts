...
export function calculateStudentChecklistScores(rawInput?: Partial<StudentChecklistData> | null) {
  ...
  const summaries: SectionSummary[] = [
    ...
    },
    {
      ...
      subtitle: "Full Stack, Backend, Frontend, Mobile, Cloud, Team & Open Source Enterprise Projects",
      iconName: "Layers",
      ...
      recommendedStatLabel: "Verified Projects",
      recommendedStatValue: `${dev.filter((d) => d.verified).length}/${dev.length}`,
      recommendedStatSub: "Faculty & Repo Verified",
      statusColor: "#06B6D4",
    },
    {
      sectionId: 5,
