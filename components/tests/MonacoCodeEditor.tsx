  ...
  const handleBeforeMount = (monaco: any) => {
    monaco.editor.defineTheme("campus-dark", {
      ...
      rules: [
        ...
        { token: "delimiter.bracket", foreground: "f59e0b", fontStyle: "bold" },
        { token: "delimiter.parenthesis", foreground: "a78bfa", fontStyle: "bold" },
        { token: "delimiter.square", foreground: "38bdf8", fontStyle: "bold" },
        { token: "delimiter.curly", foreground: "f59e0b", fontStyle: "bold" },
        { token: "delimiter", foreground: "cbd5e1", fontStyle: "bold" },
      ],
      colors: {
        "editor.background": "#090d16",
        "editor.foreground": "#f1f5f9",
        "editorCursor.foreground": "#38bdf8",
        "editor.lineHighlightBackground": "#131b2e60",
    ...
    monaco.editor.defineTheme("campus-light", {
      ...
      rules: [
        ...
        { token: "delimiter.bracket", foreground: "b45309", fontStyle: "bold" },
        { token: "delimiter.parenthesis", foreground: "6d28d9", fontStyle: "bold" },
        { token: "delimiter.square", foreground: "0284c7", fontStyle: "bold" },
        { token: "delimiter.curly", foreground: "b45309", fontStyle: "bold" },
        { token: "delimiter", foreground: "334155", fontStyle: "bold" },
      ],
      colors: {
        ...
        "editor.inactiveSelectionBackground": "#c7d2fe30",
        ...
        "editorBracketHighlight.foreground3": "#0284c7",
