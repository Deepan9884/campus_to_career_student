      ...
      {parts.map((part, idx) => {
        if (part.startsWith("```") && part.endsWith("```")) {
          ...
          return (
            ...
            >
              {lang && (
                <div className="text-[10px] uppercase font-bold text-slate-300 pb-1 border-b border-slate-700 flex justify-between items-center">
                  <span>{lang}</span>
                  <Code2 className="h-3 w-3 text-slate-300" />
                </div>
              )}
        ...
        return (
          <p key={idx} className={`text-[15px] md:text-base leading-relaxed antialiased ${isLightMode ? "text-slate-800 font-normal" : "text-slate-100 font-medium"} whitespace-pre-line`}>
      ...
      >
        ...
        >
          ...
          <div className="space-y-1">
            ...
            <p className={`text-xs font-medium ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
            ...
            >
              <p className={`text-[11px] font-semibold uppercase ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>Overall Score</p>
              <p className={`text-2xl font-black mt-1 ${isLightMode ? "text-blue-700" : "text-blue-300"}`}>{result.score}%</p>
              <span
            ...
            >
              <p className={`text-[11px] font-semibold uppercase ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>Sec 1: MCQs</p>
              <p className={`text-xl font-bold mt-1 ${isLightMode ? "text-indigo-700" : "text-indigo-300"}`}>
                {result.sectionBreakdown?.section1?.score ?? 80}%
              </p>
              <span className={`text-[10px] font-medium ${isLightMode ? "text-slate-600" : "text-slate-400"}`}>5 Conceptual Questions</span>
            </div>
            ...
            >
              <p className={`text-[11px] font-semibold uppercase ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>Sec 2: Coding</p>
              <p className={`text-xl font-bold mt-1 ${isLightMode ? "text-emerald-700" : "text-emerald-300"}`}>
                {result.sectionBreakdown?.section2?.score ?? 85}%
              </p>
              <span className={`text-[10px] font-medium ${isLightMode ? "text-slate-600" : "text-slate-400"}`}>Hands-on Challenge</span>
            </div>
            ...
            >
              <p className={`text-[11px] font-semibold uppercase ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>Sec 3: Tough MCQs</p>
              <p className={`text-xl font-bold mt-1 ${isLightMode ? "text-amber-700" : "text-amber-300"}`}>
                {result.sectionBreakdown?.section3?.score ?? 75}%
              </p>
              <span className={`text-[10px] font-medium ${isLightMode ? "text-slate-600" : "text-slate-400"}`}>Advanced Questions</span>
            </div>
          </div>
          ...
          <div
            className={`p-3.5 rounded-2xl border ${
              isLightMode ? "bg-slate-50 border-slate-200" : "bg-[#0b1329] border-slate-700"
            } flex items-center justify-between text-xs ${isLightMode ? "text-slate-800" : "text-slate-200"}`}
          >
            <div className="flex items-center gap-2">
              <TrendingUp className={`h-4 w-4 ${isLightMode ? "text-blue-600" : "text-blue-300"}`} />
              <span className="font-bold">Time Allocation Pacing:</span>
            </div>
            <div className={`flex gap-4 text-[11px] font-medium ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>
              <span>Sec 1: <strong className={isLightMode ? "text-slate-900" : "text-white"}>{formatDuration(timeSpentBySection.sec1)}</strong></span>
              <span>Sec 2: <strong className={isLightMode ? "text-slate-900" : "text-white"}>{formatDuration(timeSpentBySection.sec2)}</strong></span>
              <span>Sec 3: <strong className={isLightMode ? "text-slate-900" : "text-white"}>{formatDuration(timeSpentBySection.sec3)}</strong></span>
            </div>
          </div>
          ...
          <div className="space-y-3 text-left">
            <div className="flex items-center justify-between">
              <p className={`text-xs font-bold ${isLightMode ? "text-slate-800" : "text-slate-200"}`}>Detailed Section Review & Solutions</p>
              <span className={`text-[11px] font-medium ${isLightMode ? "text-slate-600" : "text-slate-400"}`}>{result.questionResults?.length || 0} Questions Evaluated</span>
            </div>
              ...
              {result.questionResults?.map((qr, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    {qr.userAnswerText && (
                      <div className={`text-[11px] ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>
                        <span className={`font-semibold ${isLightMode ? "text-slate-700" : "text-slate-300"}`}>Your Answer: </span>
                        <span className={`font-mono truncate max-w-md inline-block align-bottom ${isLightMode ? "text-slate-800" : "text-slate-200"}`}>
                    ...
                    {qr.correctAnswer && !isCorrect && (
                      <div className={`text-[11px] font-medium ${isLightMode ? "text-emerald-700" : "text-emerald-300"}`}>
                        <span className="font-semibold">Correct Answer: </span>
                        <span>{qr.correctAnswer}</span>
                      </div>
                    )}

                    <p className={`text-[11px] leading-relaxed p-2 rounded-lg border ${isLightMode ? "text-slate-700 bg-slate-100 border-slate-200" : "text-slate-200 bg-slate-900/60 border-slate-700"}`}>
                      {qr.feedback}
                    </p>
                  </div>
                );
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-3 md:gap-4 min-w-0">
          ...
          >
            ...
            <div className="hidden sm:block">
              ...
              <p className={`text-[11px] font-semibold truncate max-w-xs ${isLightMode ? "text-slate-600" : "text-slate-200"}`}>{skillName}</p>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2.5 md:gap-3.5">
            ...
            className={`hidden lg:flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold border ${
              isOnline
                ? isLightMode
                  ...
                  : "text-slate-100 bg-slate-800 border-slate-600"
          ...
          <button
            ...
            className={`p-2 rounded-lg border text-xs font-semibold flex items-center gap-1.5 ${
              isLightMode ? "bg-slate-100 border-slate-300 text-slate-700" : "bg-slate-800 border-slate-600 text-slate-100"
              ...
              >
                ...
                >
                  <div className="flex items-center gap-2 truncate">
                    ...
                    <span className={isLightMode ? "text-slate-400" : "text-slate-400"}>•</span>
                    ...
                    <button
                      ...
                      className={`px-2.5 py-1 rounded-lg text-xs font-bold transition flex items-center gap-1 border ${
                        isCurrentQFlagged
                          ...
                          : "bg-slate-800 border-slate-500 text-slate-100 hover:text-white hover:bg-slate-700"
                      }`}
                ...
                <div
                  className={`flex-1 overflow-y-auto p-6 space-y-6 text-[15px] antialiased ${
                ...
                >
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`text-xs font-medium ${isLightMode ? "text-slate-600" : "text-slate-200"}`}>{currentQ?.sectionTitle || `Section ${currentSection}`}</span>
                    </div>
                  ...
                  <div className="max-w-2xl w-full mx-auto space-y-6 my-auto">
                    <div className={`flex items-center justify-between pb-3 border-b ${isLightMode ? "border-slate-200" : "border-slate-700"}`}>
                      <div className="space-y-0.5">
                        <h3 className={`text-[15px] font-bold flex items-center gap-2 antialiased ${isLightMode ? "text-slate-900" : "text-white"}`}>
                          <span>Select the Correct Answer</span>
                          <span className={`text-[11px] font-medium hidden sm:inline ${isLightMode ? "text-slate-500" : "text-slate-300"}`}>
                            (or press keys 1-4 / A-D)
                          </span>
                        </h3>
                        <p className={`text-sm ${isLightMode ? "text-slate-600" : "text-slate-200"}`}>
                      ...
                      {currentAnswer && (
                        <button
                          ...
                          className={`text-xs font-medium transition flex items-center gap-1 ${isLightMode ? "text-slate-500 hover:text-red-600" : "text-slate-300 hover:text-red-300"}`}
                        >
                ...
                <>
                  ...
                  <div className="flex-1 relative overflow-hidden">
                    <MonacoCodeEditor
                      ...
                      isRuntimeError={Boolean(executionResult?.isRuntimeError)}
                      onClearErrorLine={() => {
                        setErrorLine(null);
                        setErrorMessage(null);
                      }}
                  ...
                  >
                    ...
                    {activeTab === "testcases" && (
                      ...
                      >
                        {executionResult?.isCompilationError || executionResult?.compilationError || executionResult?.isRuntimeError ? (
                          <CompilerErrorBanner
                            errorText={executionResult.stderr || executionResult.errorMessage || errorMessage || "Runtime / compilation error in code."}
                            errorLine={errorLine || executionResult?.errorLine}
                            statement={executionResult?.statement}
                            isRuntimeError={Boolean(executionResult?.isRuntimeError)}
                            language={selectedLang}
                            isLight={isLightMode}
                            ...
                            {(() => {
                              ...
                              return (
                                <div className="space-y-2 pt-1">
                                  <div className={`flex justify-between items-center text-[10px] font-medium border-b pb-1 ${isLightMode ? "text-slate-600 border-slate-200" : "text-slate-300 border-slate-700"}`}>
                                    ...
                                    <span>Execution Time: <strong className={isLightMode ? "text-slate-900" : "text-slate-100"}>{activeTC.executionTimeMs}ms</strong></span>
                                  </div>

                                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                                    <div className={`p-2 rounded-lg border space-y-1 ${isLightMode ? "bg-slate-50 border-slate-200" : "bg-black/50 border-slate-700"}`}>
                                      <div className={`text-[10px] uppercase font-semibold ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>Input</div>
                                      <pre className={`font-mono text-xs whitespace-pre-wrap max-h-16 overflow-y-auto ${isLightMode ? "text-blue-800" : "text-blue-200"}`}>
                                        {activeTC.input || "(no stdin input)"}
                                      </pre>
                                    </div>

                                    <div className={`p-2 rounded-lg border space-y-1 ${isLightMode ? "bg-slate-50 border-slate-200" : "bg-black/50 border-slate-700"}`}>
                                      <div className={`text-[10px] uppercase font-semibold ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>Expected Output</div>
                                      <pre className={`font-mono text-xs whitespace-pre-wrap max-h-16 overflow-y-auto ${isLightMode ? "text-emerald-800" : "text-emerald-200"}`}>
                                        {activeTC.expectedOutput || "(none)"}
                                      </pre>
                                    </div>

                                    <div className={`p-2 rounded-lg border space-y-1 ${isLightMode ? "bg-slate-50 border-slate-200" : "bg-black/50 border-slate-700"}`}>
                                      <div className={`text-[10px] uppercase font-semibold ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>Actual Output</div>
                                      <pre
                                  ...
                                  {activeTC.error && activeTC.status !== "Runtime Error" && (
                          ...
                          <div className={`text-xs py-2 space-y-1 font-medium ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>
                            {currentQ?.testCases && currentQ.testCases.length > 0 ? (
                              <>
                                <div className={isLightMode ? "text-slate-800" : "text-slate-200"}>
                                  This problem has{" "}
                                  <strong className={isLightMode ? "text-blue-700" : "text-blue-300"}>{currentQ.testCases.length} sample test cases</strong>.
                                </div>
                                <div className={`text-[11px] ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>
                    ...
                    {activeTab === "custom" && (
                      <div className="flex-1 p-3 flex flex-col gap-2 overflow-hidden">
                        <div className="flex items-center justify-between">
                          <span className={`text-[11px] font-semibold ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>Custom Stdin / Parameters:</span>
                          <button
                        ...
                        <textarea
                          ...
                          className={`flex-1 p-2.5 border rounded-lg text-xs font-mono resize-none focus:outline-none focus:border-blue-500 ${isLightMode ? "bg-white border-slate-300 text-slate-900 placeholder:text-slate-400" : "bg-black/60 border-slate-600 text-slate-100 placeholder:text-slate-500"}`}
                        />
                      </div>
                    )}
                    ...
                    {activeTab === "console" && (
                      ...
                      >
                        {(executionResult?.isCompilationError || executionResult?.compilationError || executionResult?.isRuntimeError || executionResult?.stderr || errorMessage) && (
                          <CompilerErrorBanner
                        ...
                        {executionResult ? (
                          <>
                            ...
                            {executionResult.stdout && (
                              <div className="space-y-0.5">
                                <span className="text-[10px] text-slate-300 uppercase font-bold tracking-wider">[STDOUT]</span>
                                <pre className="text-emerald-300 whitespace-pre-wrap p-2 bg-slate-950/80 rounded border border-slate-700">{executionResult.stdout}</pre>
                              </div>
                            )}

                            {executionResult.stderr && !executionResult.isCompilationError && !executionResult.compilationError && (
                              <div className="space-y-0.5 pt-1">
                                <span className="text-[10px] text-red-300 uppercase font-bold tracking-wider">[STDERR / RUNTIME ERROR]</span>
                                <pre className="text-red-300 whitespace-pre-wrap p-2 bg-red-950/30 rounded border border-red-900/40">{executionResult.stderr}</pre>
                              </div>
                            )}

                            {!executionResult.stdout && !executionResult.stderr && (
                              <span className={isLightMode ? "text-slate-600" : "text-slate-300"}>Program executed successfully with empty output.</span>
                            )}
                          </>
                        ) : (
                          <span className={isLightMode ? "text-slate-500" : "text-slate-300"}>No compiler logs yet. Write code and click &quot;Run Test Cases&quot;.</span>
                        )}
                      </div>
                    )}
                  </div>
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <span className={`text-xs font-semibold hidden sm:inline ${isLightMode ? "text-slate-600" : "text-slate-200"}`}>
            <strong className={isLightMode ? "text-slate-900" : "text-white"}>{answeredCount}</strong>/{quiz.questions.length} Answered
          </span>
      ...
      {showMatrixDrawer && (
        <div className="fixed inset-0 z-[999999] bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 md:p-6 select-none">
          ...
          >
            <div className={`flex items-center justify-between border-b pb-3 ${isLightMode ? "border-slate-200" : "border-slate-700"}`}>
              <div className="flex items-center gap-2">
                <Grid className={`h-5 w-5 ${isLightMode ? "text-blue-600" : "text-blue-300"}`} />
                <h3 className={`text-base font-bold ${isLightMode ? "text-slate-900" : "text-white"}`}>Assessment Question Matrix</h3>
              </div>
              <button
                onClick={() => setShowMatrixDrawer(false)}
                className={`text-xs font-semibold transition px-2 py-1 rounded-lg ${isLightMode ? "text-slate-600 hover:text-slate-900 bg-slate-100 hover:bg-slate-200" : "text-slate-300 hover:text-white bg-slate-800 hover:bg-slate-700"}`}
              >
                Close (ESC)
              </button>
            </div>
            ...
            {/* Matrix Legend */}
            <div className={`flex flex-wrap gap-4 text-xs font-medium p-3 rounded-xl border ${isLightMode ? "text-slate-700 bg-slate-50 border-slate-200" : "text-slate-300 bg-slate-900/60 border-slate-700"}`}>
              <div className="flex items-center gap-1.5">
            ...
            <div className="space-y-4">
              {/* Section 1 */}
              <div className="space-y-2">
                <span className={`text-xs font-bold uppercase tracking-wide ${isLightMode ? "text-indigo-700" : "text-indigo-300"}`}>
                    ...
                    return (
                      <button
                        ...
                        className={`p-2.5 rounded-xl text-xs font-bold border transition text-center relative ${
                          isFlagged && hasAns
                            ? isLightMode
                              ? "bg-amber-50 border-amber-400 text-amber-800 ring-1 ring-amber-400/40"
              ...
              {/* Section 2 */}
              <div className="space-y-2">
                <span className={`text-xs font-bold uppercase tracking-wide ${isLightMode ? "text-emerald-700" : "text-emerald-300"}`}>
              ...
              {/* Section 3 */}
              <div className="space-y-2">
                <span className={`text-xs font-bold uppercase tracking-wide ${isLightMode ? "text-amber-700" : "text-amber-300"}`}>
        ...
        <div className="fixed inset-0 z-[999999] bg-black/80 backdrop-blur-sm flex items-center justify-center p-6 select-none">
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <p className={`text-xs font-medium ${isLightMode ? "text-slate-600" : "text-slate-300"}`}>
                You have answered <strong className={isLightMode ? "text-blue-700" : "text-blue-300"}>{answeredCount}</strong> of{" "}
                <strong className={isLightMode ? "text-blue-700" : "text-blue-300"}>{quiz.questions.length}</strong> questions across all 3 sections.
              </p>
            </div>

            <div className={`rounded-2xl p-3.5 text-xs text-left space-y-1.5 border ${isLightMode ? "bg-slate-50 border-slate-200 text-slate-700" : "bg-[#0b1329] border-slate-700 text-slate-200"}`}>
              ...
              {flaggedQuestions.size > 0 && (
                <div className={`flex justify-between pt-1 border-t ${isLightMode ? "text-amber-700 border-amber-200" : "text-amber-300 border-slate-700"}`}>
